...
const service = require('../services/Pegawai_services')
...
const getById = async (req, res) => {
    try {
        ...
        const data = await service.getById({ IDPEGAWAI: req.params.id })
        response = { ...requestResponse.success, data }
    } catch (error) {
        logger.error(error)
        response = { ...requestResponse.server_error }
...
const updateOne = async (req, res) => {
    try {
        const data = await service.updateOne({ IDPEGAWAI: req.params.id }, req.body)
        response = { ...requestResponse.success, data }
    } catch (error) {
        logger.error(error)
        response = { ...requestResponse.server_error }
...
const deleteOne = async (req, res) => {
    try {
        console.log(req.params.id)
        const data = await service.deleteOne({ IDPEGAWAI: req.params.id })
        response = { ...requestResponse.success, data }
    } catch (error) {
        logger.error(error)
        response = { ...requestResponse.server_error }
